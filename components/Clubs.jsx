    ...
    <Container>
        ...
        <ClubGrid>
            <ClubCard className='one'>
                ...
                <CardText>Unveil the creativity behind our web development projects, where we build dynamic and user-friendly websites and applications</CardText>
            ...
            <ClubCard className='two'>
                ...
                <CardText>Explore cutting-edge projects and innovative solutions crafted by our talented team of designers in the Technical Society</CardText>
                <ExploreButton>Explore</ExploreButton>
            </ClubCard>
            <ClubCard className='three'>
                ...
                <CardText>Dive into our programming initiatives, where coding enthusiasts develop powerful software and drive technological advancements</CardText>
                <ExploreButton>Explore</ExploreButton>
            </ClubCard>
            <ClubCard className='four'>
                ...
                <CardText>Discover our Android development endeavors, showcasing innovative apps and solutions for mobile technology</CardText>
                <ExploreButton>Explore</ExploreButton>
            </ClubCard>
        </ClubGrid>
            <Text1>
